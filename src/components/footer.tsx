...
function Footer() {
  return (
    <div className='w-full px-2'>
      <div className='pb-14 mb-20 md:mb-2 flex px-6 relative items-start w-full flex-col pt-6 border rounded-md bg-black'>
        ...
        <div className='absolute bottom-0 left-0 w-full px-6 py-2 flex justify-between items-center'>
          <span className='flex items-center gap-2'>
            Made with{" "}
            <Heart size={12} className='stroke-red-500 fill-red-500' />
          </span>
          <div className='flex items-center gap-2'>
