...
function ProductTitleCard({
  ...
  return (
    <div className='absolute bottom-0 -left-3 p-2 overflow-hidden duration-200 ease-in-out cursor-pointer'>
      <div className='p-2 rounded-r-3xl min-w-20 border border-zinc-800 flex group-hover:border-sky-500 items-center gap-2 backdrop-blur-sm bg-black/30 pl-4 max-h-14'>
